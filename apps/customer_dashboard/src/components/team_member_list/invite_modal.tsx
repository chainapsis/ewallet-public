...
const UserPlusIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path
      d="M12 15.5H7.5c-1.4 0-2.1 0-2.6.27a2.5 2.5 0 0 0-1.1 1.1C3.5 17.4 3.5 18.1 3.5 19.5M19 19.5v-5m-2.5 2.5h5M14.5 7.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z"
      stroke="var(--fg-primary)"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
